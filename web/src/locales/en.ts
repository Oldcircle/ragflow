export default {
  translation: {
    ...
    login: {
      ...
      continue: 'Continue',
      title: 'Trusted enterprise knowledge base and agent workbench',
      start: "Let's get started",
      description:
        'Manage enterprise documents, grounded answers, and agent workflows in one place.',
      review: 'from 500+ reviews',
      seeAll: 'See all',
      tagline: 'Agent-first enterprise knowledge base',
      policyCardTitle: 'Policy advisor agent',
      trustedBadge: 'Grounded citations',
      featureKbLabel: 'Dataset',
      featureKbValue: 'Shenzhen housing policy · 22 documents',
      featureToolLabel: 'Tools',
      featureToolValue: 'rag_retrieve · rag_read_document',
      featureCitationLabel: 'Citation',
      featureCitationValue: '[1] Public Rental Housing Regulation',
    },
    header: {
      ...
      agentV2Title: 'Agent v2',
      agentV2Description:
        'Autonomous retrieval, document reading and visible tool calls for trusted Q&A on policy, legal and research scenarios.',
      workspaceSettings: 'Workspace settings',
      helpCenter: 'Help',
      docsUrl: 'https://ragflow.io/docs/dev/category/user-guides',
      workspaceGroup: 'Workspace',
      buildGroup: 'Build',
    },
    workspaceHome: {
      tagline: 'Enterprise knowledge workspace',
      heroTitle:
        'Manage enterprise knowledge so every agent answer is grounded',
      heroDescription:
        'Unify documents, retrieval, conversations, tool calls and source citations to build a trusted internal knowledge base.',
      quickActions: 'Quick start',
      newDataset: 'Create a dataset',
      newDatasetHint: 'Upload documents and start parsing',
      openAgent: 'Open agent',
      openAgentHint: 'Multi-step Q&A grounded in your knowledge base',
      startChat: 'Start a chat',
      startChatHint: 'Use an existing chat assistant',
      datasets: 'Datasets',
      datasetsHint: 'Knowledge spaces visible to your team',
      documents: 'Documents',
      documentsHint: 'Across visible datasets',
      chunks: 'Chunks',
      chunksHint: 'Used for semantic retrieval',
      tokens: 'Tokens',
      tokensHint: 'Total parsed text volume',
    },
    agentV2: {
      ...
      pendingQuestion: 'Agent is waiting for your answer',
      pendingPlan: 'Agent submitted a plan',
      multiSelectHint: 'Choose one or more',
      singleSelectHint: 'Choose one',
      customAnswer: 'Or enter a custom answer (optional)',
      customPlaceholder: 'e.g. another KB name',
      submitAnswer: 'Send answer',
      planSteps: 'Execution steps',
      affectedResources: 'Affected resources',
      estimatedCost: 'Estimated cost',
      reversibleHint: 'How to revert',
      riskLevel: 'Risk',
      irreversible: 'Irreversible',
      planApprove: 'Approve',
      planReject: 'Reject',
      planRequestChanges: 'Request changes',
      planChangesPrompt: 'Tell the agent what to change:',
      planContentPreview: 'Content preview',
      planPreviewTruncated: '(excerpt)',
      planPreviewSource: 'Source',
      charactersShort: 'chars',
      attachFile: 'Attach file',
      attachmentRemove: 'Remove attachment',
      dropToAttach: 'Drop files to attach',
      waitUpload: 'Waiting for upload to finish',
      attachmentNoSession: 'Create or pick a session before uploading',
      attachmentUploadFailed: 'Attachment upload failed',
      attachmentRejectFailed: 'Server-side removal failed (UI already cleared)',
      newSessionDialogTitle: 'Create a new agent session',
      sessionName: 'Session name',
      sessionNamePlaceholder: 'e.g. Policy advisor',
      selectKnowledgeBases: 'Knowledge bases',
      multiKbHint:
        'Select at least one. All KBs must share the same embedding model.',
      noKbHint:
        "You haven't created any knowledge base yet. Go to the Dataset section to create one first.",
      model: 'Model',
      modelKeyHint:
      ...
      confirmDelete: 'Delete this session and all its history?',
      untitled: 'Untitled',
      today: 'Today',
      pastWeek: 'Past week',
      earlier: 'Earlier',
      noSessions:
        'No sessions yet. Click "New session" to create your first Agent.',
      emptyTitle: 'Ask the agent anything',
      emptyHint:
        'The agent decides when to retrieve from your KB, query the graph, or read a full document. All tool calls show up on the right.',
      thinking: 'Thinking',
      toolCalls: 'Tool calls',
      toolCallsCount: '{{count}} call(s)',
      noToolCallsYet: 'No tool calls yet',
      emptyToolCallsHint:
        'Tool calls made by the agent will show up here with args and results.',
      args: 'Arguments',
      result: 'Result',
      error: 'Error',
      running: 'running',
      ...
      send: 'Send',
      abort: 'Stop',
      pickSessionFirst: 'Pick a session or create a new one to start chatting',
...
Example: Virtual Hosted Style`,
      ...
      botChannelsDescription:
        'Bridge enterprise IM (Lark / DingTalk / WeCom) into Agent v2. Once configured, mentioning the bot in a chat triggers a knowledge-grounded reply. Copy the callback URL into the channel admin console.',
      botAddChannel: 'Add bot',
      botEdit: 'Edit',
      botDelete: 'Delete',
      botTest: 'Test connection',
      botTestSuccess: 'Connected. Bot open_id: {{id}}',
      botTestFailed: 'Connection failed',
      botEnabled: 'Enabled',
      botDisabled: 'Disabled',
      botCallbackUrl: 'Callback URL',
      botCopyUrl: 'Copy',
      botCopied: 'Copied',
      botSavedTitle: 'Bot saved',
      botSavedHint:
        'Paste the callback URL, encrypt key and verification token into Lark Open Platform → Event subscription → Configure event callback, and subscribe to the "Receive message v2.0 (im.message.receive_v1)" event.',
      botFormChannelType: 'Channel',
      botFormChannelTypeFeishu: 'Lark / Feishu',
      botFormChannelTypeDingtalk: 'DingTalk (coming soon)',
      botFormChannelTypeWecom: 'WeCom (coming soon)',
      botFormAccountId: 'Account ID',
      botFormAccountIdHint:
        'Unique within your tenant; used in the webhook URL — no special characters.',
      botFormName: 'Name',
      botFormAppId: 'App ID',
      botFormAppSecret: 'App Secret',
      botFormEncryptKey: 'Encrypt Key',
      botFormEncryptKeyHint:
        'Required for Feishu webhook signature verification.',
      botFormVerificationToken: 'Verification Token',
      botFormApiBase: 'API Base',
      botFormApiBaseHint:
        'Override for private deployments. Defaults to https://open.feishu.cn',
      botFormDefaultKbs: 'Default datasets',
      botFormDefaultKbsHint:
        'Datasets bound to a new bot conversation. Multi-select.',
      botFormSessionScope: 'Session scope',
      botFormSessionScopeGroup: 'One session per group',
      botFormSessionScopeGroupSender:
        'Per-sender session in a group (recommended)',
      botFormSessionScopeGroupTopic: 'Per-thread session',
      botFormSessionScopeGroupTopicSender: 'Per-thread + per-sender',
      botFormSystemPrompt: 'System Prompt',
      botFormSystemPromptHint:
        'Used by new bot conversations. Empty falls back to the agent default.',
      botFormEnabled: 'Enabled',
      botRevokeConfirm:
        'Delete this bot? Linked conversation mappings will also be removed.',
      botActiveSessions: 'Active sessions',
      botEmptyTitle: 'No bot channels yet',
      botEmptyHint:
        'Click "Add bot" in the top right to connect Lark / Feishu and other channels.',
      username: 'Name',
...
[Insert text here]`,
    ...
    audit: {
      ...
      title: 'Access audit',
      description:
        'Every sensitive operation — dataset retrieval, agent session creation, bot webhook receive, membership change — is recorded here. Tenant admins can filter by action, resource, result, user. All denies are kept.',
      fieldAction: 'Action',
      fieldResourceType: 'Resource type',
      fieldResourceId: 'Resource ID',
      fieldResourceIdPlaceholder: 'Exact match',
      fieldResult: 'Result',
      fieldUser: 'User ID',
      fieldUserPlaceholder: 'Exact user ID',
      fieldReason: 'Reason',
      resultAllow: 'Allow',
      resultDeny: 'Deny',
      applyFilters: 'Apply',
