export default {
  translation: {
    ...
    login: {
      ...
      register: '创建账户',
      continue: '继续',
      title: '可信企业知识库与 Agent 工作台',
      start: '立即开始',
      description:
        '统一管理企业文档、检索引用与智能体协作，让每一次回答都有依据。',
      review: '来自 500 多条评论',
      tagline: 'Agent-first 企业知识库',
      policyCardTitle: '政策咨询 Agent',
      trustedBadge: '可信引用',
      featureKbLabel: '知识库检索',
      featureKbValue: '深圳保障房政策库 · 22 份文档',
      featureToolLabel: '工具调用',
      featureToolValue: 'rag_retrieve · rag_read_document',
      featureCitationLabel: '回答依据',
      featureCitationValue: '[1] 公共租赁住房管理办法',
    },
    header: {
      knowledgeBase: '知识库',
      chat: '对话',
    ...
    workspaceHome: {
      tagline: '企业知识工作台',
      heroTitle: '管理企业知识，让 Agent 的每一次回答都有依据',
      heroDescription:
        '汇聚文档、检索、对话、工具调用和引用来源，面向企业内部场景构建可信知识库。',
      quickActions: '快速入口',
      newDataset: '新建知识库',
      newDatasetHint: '上传文档并开始解析',
      openAgent: '打开 Agent',
      openAgentHint: '基于知识库进行多步问答',
      startChat: '开始对话',
      startChatHint: '使用现有聊天助手',
      datasets: '知识库',
      datasetsHint: '团队可用知识空间',
      documents: '文档',
      documentsHint: '当前可见知识库',
      chunks: '切片',
      chunksHint: '用于语义召回',
      tokens: 'Token',
      tokensHint: '解析文本规模',
    ...
    agentV2: {
      ...
      pendingQuestion: 'Agent 请你回答',
      pendingPlan: 'Agent 提交了计划',
      multiSelectHint: '可多选',
      singleSelectHint: '单选',
      customAnswer: '或输入自定义答复（可选）',
      customPlaceholder: '例如：另一个 KB 名称',
      submitAnswer: '发送回答',
      planSteps: '执行步骤',
      ...
      planApprove: '批准执行',
      planReject: '拒绝',
      planRequestChanges: '要求调整',
      planChangesPrompt: '告诉 Agent 要怎么改：',
      planContentPreview: '内容预览',
      planPreviewTruncated: '（节选）',
      planPreviewSource: '来源',
      charactersShort: '字符',
      attachFile: '添加附件',
      attachmentRemove: '移除附件',
      dropToAttach: '松开鼠标上传附件',
      waitUpload: '等待附件上传完成',
      attachmentNoSession: '请先创建会话再上传附件',
      attachmentUploadFailed: '附件上传失败',
      attachmentRejectFailed: '附件撤销在服务器端失败（UI 已移除）',
      newSessionDialogTitle: '新建 Agent 会话',
      sessionName: '会话名称',
      sessionNamePlaceholder: '如：保障房政策顾问',
      selectKnowledgeBases: '选择知识库',
      multiKbHint: '至少选一个；多个知识库必须共享同一 embedding 模型。',
      noKbHint: '尚未创建知识库，请先在"知识库"中新建一个。',
      model: '模型',
      modelKeyHint:
      ...
      confirmDelete: '确认删除该会话及其所有历史？',
      untitled: '未命名会话',
      today: '今天',
      pastWeek: '最近一周',
      earlier: '更早',
      noSessions: '暂无会话。点击"新建会话"创建你的第一个 Agent。',
      emptyTitle: '向 Agent 提问',
      emptyHint:
        'Agent 会自主决定何时检索知识库、查询图谱或读完整文档。所有工具调用显示在右侧。',
      thinking: '思考过程',
      toolCalls: '工具调用',
      toolCallsCount: '{{count}} 次调用',
      noToolCallsYet: '尚未触发任何工具',
      emptyToolCallsHint: 'Agent 调用的工具会在这里展示参数和结果。',
      args: '参数',
      result: '结果',
      error: '错误',
      running: '运行中',
      ...
      send: '发送',
      abort: '中断',
      pickSessionFirst: '请先选择或新建一个会话',
      inputPlaceholder: '向 Agent 提问...',
      ...
      citationKindPhantom: '未检索却带引用（疑似幻觉）',
...
例如：一条带有 1024 维嵌入的 1 KB 消息大约使用 9 KB。5 MB 的默认限制大约可容纳 500 条此类消息。`,
    ...
    knowledgeList: {
      ...
      membersTitle: '成员管理',
      membersDescription:
        '为知识库授予角色：所有者、管理员、协作者、只读。需要管理员或所有者权限才能管理成员。',
      memberRoleOwner: '所有者',
      memberRoleAdmin: '管理员',
      memberRoleContributor: '协作者',
      memberRoleViewer: '只读',
      memberRoleOwnerHint: '创建者，完全控制权限（不可改）',
      memberRoleAdminHint: '管理成员、设置、删除知识库',
      memberRoleContributorHint: '上传 / 解析 / 删除文档',
      memberRoleViewerHint: '检索 / 问答 / 引用',
      memberInvite: '邀请成员',
      memberInviteEmail: '成员邮箱',
      memberInviteEmailPlaceholder: '请输入已注册账号的邮箱',
      memberInviteRole: '角色',
      memberInviteSubmit: '邀请',
      memberRevokeConfirm: '确认移除该成员的访问权限？',
      memberRevokeOwnerError: '不能移除创建者；如需转让，请先变更知识库所有人',
      memberImplicitTip: '隐式（继承自 KB 创建者）',
      memberAccessDenied: '你没有权限管理该知识库的成员（需要管理员或所有者）',
    },
    knowledgeDetails: {
      metadata: {
        fields: '字段',
...
示例：general/v2/`,
      ...
      botChannelsDescription:
        '把企业 IM（飞书 / 钉钉 / 企微）接入 Agent v2，员工在群里 @ 机器人即可基于知识库问答。回调 URL 复制到飞书后台「事件订阅」即可。',
      botAddChannel: '添加机器人',
      botEdit: '编辑',
      botDelete: '删除',
      botTest: '测试连接',
      botTestSuccess: '连接成功，Bot open_id: {{id}}',
      botTestFailed: '连接失败',
      botEnabled: '启用',
      botDisabled: '已停用',
      botCallbackUrl: '回调 URL',
      botCopyUrl: '复制',
      botCopied: '已复制',
      botSavedTitle: '机器人已保存',
      botSavedHint:
        '把上面的回调 URL、Encrypt Key、Verification Token 填到飞书开放平台 → 事件订阅 → 配置事件回调，并订阅 “接收消息 v2.0 (im.message.receive_v1)” 事件。',
      botFormChannelType: '渠道',
      botFormChannelTypeFeishu: '飞书',
      botFormChannelTypeDingtalk: '钉钉（敬请期待）',
      botFormChannelTypeWecom: '企业微信（敬请期待）',
      botFormAccountId: '账号标识',
      botFormAccountIdHint:
        '同 tenant 内唯一；用于 webhook URL，不要含特殊字符',
      botFormName: '名称',
      botFormAppId: 'App ID',
      botFormAppSecret: 'App Secret',
      botFormEncryptKey: 'Encrypt Key',
      botFormEncryptKeyHint: '用于飞书 webhook 签名验证；不可为空',
      botFormVerificationToken: 'Verification Token',
      botFormApiBase: 'API Base',
      botFormApiBaseHint: '私有部署时改为内部地址，默认 https://open.feishu.cn',
      botFormDefaultKbs: '默认知识库',
      botFormDefaultKbsHint: '新会话默认绑定的知识库；可多选',
      botFormSessionScope: '会话粒度',
      botFormSessionScopeGroup: '整个群共用一个会话',
      botFormSessionScopeGroupSender: '群里每人独立会话（推荐）',
      botFormSessionScopeGroupTopic: '按话题分会话',
      botFormSessionScopeGroupTopicSender: '按话题 + 发件人',
      botFormSystemPrompt: 'System Prompt',
      botFormSystemPromptHint:
        '机器人新会话使用的系统提示词；为空则用 Agent 默认',
      botFormEnabled: '启用',
      botRevokeConfirm: '确认删除该机器人？关联的会话映射也会一并清理。',
      botActiveSessions: '活跃会话',
      botEmptyTitle: '尚未配置任何机器人',
      botEmptyHint: '点击右上角「添加机器人」开始接入飞书等渠道。',
      username: '用户名',
...
[在此处插入文本]`,
    ...
    trigger: {
      ...
      title: '定时 Agent 任务',
      description:
        '让 Agent 按 Cron 表达式自动跑，并把结果投递到飞书群、审计日志等。适合早 9 点行业简报、周一竞品扫描、每小时安全巡检这类主动情报场景。',
      addNew: '新建任务',
      edit: '编辑',
      runNow: '立即运行',
      runSuccess: '运行成功',
      runFailed: '运行失败',
      deleteConfirm: '确认删除该定时任务？历史运行记录也会一并清理。',
      lastRun: '上次运行',
      nextRun: '下次',
      nextRuns: '接下来 5 次',
      showHistory: '展开运行历史',
      ...
      deliveryError: '投递失败',
      fieldName: '任务名称',
      fieldNamePlaceholder: '如：保障房政策日报',
      fieldDescription: '描述（可选）',
      fieldDescriptionPlaceholder: '简短说明做什么',
      fieldCron: 'Cron 表达式',
      fieldCronHint: '5 段格式：分 时 日 月 周。点下方常用模板可快速填入。',
      fieldSession: '绑定 Agent 会话',
      fieldSessionHint: '任务会以该会话的知识库、System Prompt、模型配置执行',
      fieldSessionPlaceholder: '选择一个已有的 Agent 会话',
      fieldPrompt: '每次触发的 Prompt',
      fieldPromptHint: '每次 cron 到期都会把这段文字当用户消息发给 Agent',
      fieldPromptPlaceholder: '如：汇总最近 1 天深圳保障房政策动态并生成简报',
      fieldDelivery: '结果投递',
      deliveryAuditOnly: '仅记录（不发送）',
      deliveryFeishuBot: '发到飞书群',
      fieldBotChannel: '飞书机器人',
      fieldBotChannelPlaceholder: '选择已启用的飞书机器人',
      noBotChannel: '尚无启用的飞书机器人，请先在「机器人渠道」页添加',
      fieldChatId: '飞书 chat_id',
      fieldChatIdHint: '把机器人加入的群聊的 chat_id（以 oc_ 开头）',
      fieldEnabled: '启用',
      emptyTitle: '尚未创建任何定时任务',
      emptyHint: '新建一个，让 Agent 主动为你产出情报',
      errName: '请填任务名称',
      errCron: '请填 Cron 表达式',
      errSession: '请选择绑定的 Agent 会话',
      errPrompt: '请填 Prompt',
      errDelivery: '请选择飞书机器人并填 chat_id',
    },
    ...
    usage: {
      ...
      title: '租户用量',
      description:
        '当前租户的资源占用和配额上限。超额后系统按「硬执行」模式决定是阻塞还是仅记审计。',
      hardEnforce: '硬执行',
      hardEnforceTip: '超额请求会被直接拒绝（429 / 403）',
      softEnforce: '软模式',
      softEnforceTip: '仅记审计日志，不阻塞请求',
      cardKb: '知识库',
      cardDoc: '文档',
      cardTokens: '本月 Token',
      cardTokensSub: 'input + output 累计',
      cardCost: '本月成本',
      cardCostSub: 'LLM 调用估算',
      todayHeader: '今日用量',
      apiRequests: 'API 调用',
      botMessages: '机器人消息',
      subagents: '子 Agent 调用',
      rangeHeader: '近 {{days}} 天 Token 用量',
      limitsHeader: '配额上限',
      apiRps: 'API 每秒',
      botMessagesLimit: '机器人消息',
      subagentsLimit: '子 Agent',
      perDay: '/ 天',
    },
    ...
    audit: {
      ...
      title: '访问审计',
      description:
        '记录了知识库访问、Agent 会话创建、机器人接收消息等所有敏感操作。租户管理员可以按动作、资源、结果筛选；所有拒绝行为（deny）都会留痕。',
      fieldAction: '动作',
      fieldResourceType: '资源类型',
      fieldResourceId: '资源 ID',
      fieldResourceIdPlaceholder: '精确匹配',
      fieldResult: '结果',
      fieldUser: '用户 ID',
      fieldUserPlaceholder: '精确匹配用户 ID',
      fieldReason: '原因',
      resultAllow: '通过',
      resultDeny: '拒绝',
      applyFilters: '查询',
